#!/bin/bash
# Purpose: To generate a report that can be downloaded and contains information about the traffic, MySQL queries, and PHP pages for all applications on the server.
# Author: Guman Singh | Cloudways
# Last Edited: 07/11/2023:11:12
# Usage: bash server_report.sh 5m ;The last param(5m) can be replaced by your desired timeframe that is 5m (m=minutes) or 1h (h=hours) or 10d (d=days) etc.
